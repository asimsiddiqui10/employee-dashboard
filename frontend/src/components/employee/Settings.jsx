                  ...
                  <div className="mt-4 space-y-4">
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-3 text-sm">
                        ...
                        <p className="text-gray-500">Get notified via text message.</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="mt-4 space-y-4">
                    <div className="flex items-start">
                      ...
                      <div className="ml-3 text-sm">
                        <label htmlFor="leave-notifications" className="font-medium text-gray-700">
                          Leave Requests
                        </label>
                        <p className="text-gray-500">Updates about your leave requests.</p>
                      </div>
                    </div>
                    <div className="flex items-start">
                      <div className="flex items-center h-5">
                      ...
                      <div className="ml-3 text-sm">
                        <label htmlFor="payroll-notifications" className="font-medium text-gray-700">
                          Payroll
                        </label>
                        <p className="text-gray-500">Notifications about salary payments.</p>
                      </div>
                    </div>
                    <div className="flex items-start">
                      <div className="flex items-center h-5">
                      ...
                      <div className="ml-3 text-sm">
                        <label htmlFor="announcement-notifications" className="font-medium text-gray-700">
                          Announcements
                        </label>
                        <p className="text-gray-500">Company-wide announcements and updates.</p>
                      </div>
                    </div>
                  </div>
                </div>
